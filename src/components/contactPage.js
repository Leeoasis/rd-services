            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6 flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="contact-details w-full lg:w-1/2 shadow-lg rounded-lg p-8 bg-white animate-slow-float">
                        ...
                        <p className="mb-4"><strong>Address:</strong>3 Barham Rd Lochiel, Cape Town</p>
                        <p className="mb-4"><strong>Phone:</strong>0645547182 / 0712040033</p>
                        <p className="mb-4"><strong>Email:</strong> info@rdservices.co.za</p>
