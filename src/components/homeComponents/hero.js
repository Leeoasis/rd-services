...
import Hero from '../../assets/videos/rdhero.mp4';
      ...
      <div className="relative z-20 text-center px-4 max-w-3xl animate-floaty">
        ...
        <div className="relative z-20 px-4 py-6 bg-opacity-70 bg-black rounded-lg">
          <h1 className="text-5xl md:text-6xl font-bold mb-4 animate-slide-in-down text-shadow">
            Welcome to RD Services
          </h1>
          <p className="text-lg md:text-xl mb-6 animate-slide-in-up text-shadow">
            RD Services is your trusted partner for efficient and professional rubble removal solutions. We specialize in site clean-ups, waste disposal, and debris removal to keep your space clean and hazard-free. Contact us today for reliable service at competitive rates.
          </p>
